...
class ViewModel: ObservableObject{
    ...
    @Published var recomendations = [
        ...
        RecomendedTask(name: "Creation and Hobby", info: ""),
        RecomendedTask(name: "", info: "Engage in creative activities that bring joy and fulfillment. Whether it’s painting, writing, coding, or playing an instrument, make time for hobbies that inspire you"),
